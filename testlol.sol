...
// mapping and variables for the blacklisting system
mapping(address => bool) private _isBlackList;
uint256 public currentBlockOnEnableTrading; // gets initialized when enableTrading() is called
uint256 public blocksToBlacklist = 20; // BSC block time is ~3 seconds, so 20 blocks is ~1 mintue
uint256 public stopAtBlocksToBlacklist; // gets initialized when enableTrading() is called
uint256 public currentBlockOnTransfer; // gets initialized and updated everytime _transfer() is called

// function to enable trading
// we call this first to enable trading and get the current block number  
